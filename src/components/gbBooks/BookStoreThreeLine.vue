<template>
  <div>
      ...
      <div class="list_aa">
        <div class="list-a" v-for="(book,index) in books" :key="index" v-if="index<1" @click="getBookId(book.id)">
            <div class="list_l">
              <img :src="book.image"/>
            </div>
            <div class="list_r">
      ...
      <div class="list">
          <div class="list-b" v-for="(book,index) in books" :key="index" v-if="index>=1&&index<5">
            <img :src="book.image"/>
            <p>{{book.bookname}}</p>
            <p>{{book.author}}</p>
          </div>
